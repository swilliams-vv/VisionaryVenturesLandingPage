        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              ['3', 'Develop.', `Building, testing, and refining your solution until every detail works exactly the way it should.`],
              ['4', 'Deploy.', `Secure launch with continuous support so your business hits the ground running.`]
            ].map(([num, title, desc]) => (
