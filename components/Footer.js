    ...
    <footer className="border-t border-[#ffffff0a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <Link href="/" className="flex items-center gap-3">
          <img src="/untitle-8.png" alt="Visionary Ventures" className="h-8 md:h-10 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity" />
        ...
        <p className="text-sm text-[#71717a]">&copy; {new Date().getFullYear()} Visionary Ventures Inc. All systems nominal.</p>
